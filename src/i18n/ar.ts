...
export const ar: Translation = {
  ...
  about: {
    title: "حول أمان",
    description: "تُعد أمان شركة ناشئة مبتكرة في مجال الأمن السيبراني بالجزائر، يقودها فريق من الخبراء المتحمسين والباحثين والاستشاريين. نعتمد على أساليب عمل مرنة وتقنيات حديثة لإحداث تحول جذري في الأمن الرقمي داخل الجزائر وخارجها.",
    points: {
      consult: {
        title: "1. إستشارة",
